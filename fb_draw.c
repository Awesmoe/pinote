...
// German umlauts and sharp-s — indexed by Latin-1 byte values so draw_char can
// dispatch on them directly. strip_utf8_accents collapses the UTF-8 sequences
// (0xC3 0x84 etc.) into these single bytes before rendering.
static const uint8_t glyph_Auml[16] = {  // Ä (0xC4)
    0xC6,0x00,0x10,0x38,0x6C,0xC6,0xC6,0xFE,0xC6,0xC6,0xC6,0xC6,0x00,0x00,0x00,0x00
};
static const uint8_t glyph_Ouml[16] = {  // Ö (0xD6)
    0xC6,0x00,0x7C,0xC6,0xC6,0xC6,0xC6,0xC6,0xC6,0xC6,0xC6,0x7C,0x00,0x00,0x00,0x00
};
static const uint8_t glyph_Uuml[16] = {  // Ü (0xDC)
    0xC6,0x00,0xC6,0xC6,0xC6,0xC6,0xC6,0xC6,0xC6,0xC6,0xC6,0x7C,0x00,0x00,0x00,0x00
};
static const uint8_t glyph_szlig[16] = { // ß (0xDF)
    0x00,0x00,0x3C,0x66,0x66,0x7C,0x66,0x66,0x66,0x66,0x66,0x6C,0x60,0x60,0x00,0x00
};
static const uint8_t glyph_auml[16] = {  // ä (0xE4)
    0x00,0x00,0x00,0xCC,0x00,0x78,0x0C,0x7C,0xCC,0xCC,0xCC,0x76,0x00,0x00,0x00,0x00
};
static const uint8_t glyph_ouml[16] = {  // ö (0xF6)
    0x00,0x00,0x00,0xC6,0x00,0x7C,0xC6,0xC6,0xC6,0xC6,0xC6,0x7C,0x00,0x00,0x00,0x00
};
static const uint8_t glyph_uuml[16] = {  // ü (0xFC)
...
void draw_char(Framebuffer *fb, int x, int y, char c, uint8_t r, uint8_t g, uint8_t b, int scale) {
    ...
    switch (uc) {
        case 0xF8: glyph = glyph_degree; break;
        case 0xC4: glyph = glyph_Auml; break;
        case 0xD6: glyph = glyph_Ouml; break;
        case 0xDC: glyph = glyph_Uuml; break;
        case 0xDF: glyph = glyph_szlig; break;
        case 0xE4: glyph = glyph_auml; break;
        case 0xF6: glyph = glyph_ouml; break;
        case 0xFC: glyph = glyph_uuml; break;
        default:
