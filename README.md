...
- **Module layout system** — configurable dashboard modules (anime, chart, RSS, notes) placed via JSON config as full, half, or spanning width
...
|-------|--------|-------------|
| `type` | `"anime"`, `"chart"`, `"rss"`, `"notes"` | Which module to display |
